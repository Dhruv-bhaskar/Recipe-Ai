...
const FeatureCard = ({ icon: Icon, title, description }: FeatureCardProps) => {
  return (
    <div className="p-6 hover:shadow-xl transition-all duration-300 bg-card border-border group cursor-pointer rounded-lg border shadow-md bg-gradient-to-bl from-primary/10 to-secondary/7">
...
export default function Home() {
  return (
    <div className="min-h-screen">
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-br from-secondary to-primary/30">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-primary/12 to-secondary/10">
